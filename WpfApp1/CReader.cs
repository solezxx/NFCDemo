...
namespace Demo
{
    class CReader
    {
        ...
        [DllImport("ALL.dll", EntryPoint = "API_GetSysComm")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_SetBaudrate")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_SetDeviceAddress")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_WriteUserInfo")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ReadUserInfo")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_Inventory")]
        static extern int API_ISO15693_Inventory(IntPtr commHandle, int deviceAddress, byte flag, byte afi, byte datalen, ref byte pData, 
                                                                                                                                            ref byte nrOfCard, ref byte pBuffer);
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_Read")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_GetMulSecurity")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_Write")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_GetSysInfo")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_StayQuiet")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_Select")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_ResetToReady")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_WriteAFI")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_WriteDSFID")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_LockAFI")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_LockDSFID")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_Lock")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_ISO15693_TransCmd")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_MF_Request")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_MF_Anticoll")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_MF_Select")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_MF_Halt")]
        ...
        static extern int API_MF_Write(IntPtr commHandle, int DeviceAddress, byte mode, byte blk_add, byte num_blk, ref byte key, ref byte text, ref byte pbuffer);
        public int MF_Write(int DeviceAddress, byte mode, byte blk_add, byte num_blk, ref byte key, ref byte text, ref byte pbuffer)
        {
            if (IntPtr.Zero == m_hComm)
                return 1;
            return API_MF_Write(m_hComm, DeviceAddress, mode, blk_add, num_blk, ref key, ref text, ref pbuffer);
        }

        [DllImport("ALL.dll", EntryPoint = "API_MF_InitVal")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_MF_Dec")]
        static extern int API_MF_Dec(IntPtr commHandle, int DeviceAddress, byte mode, byte sec_num, ref byte key, int value, ref UInt32 result, ref byte pbuffer);
        public int MF_Dec(int DeviceAddress, byte mode, byte sec_num, ref byte key, int value, ref UInt32 result, ref byte pbuffer)
        {
            if (IntPtr.Zero == m_hComm)
                return 1;
        ...
        [DllImport("ALL.dll", EntryPoint = "API_MF_Inc")]
        static extern int API_MF_Inc(IntPtr commHandle, int DeviceAddress, byte mode, byte sec_num, ref byte key, int value, ref UInt32 result, ref byte pbuffer);
        public int MF_Inc(int DeviceAddress, byte mode, byte sec_num, ref byte key, int value, ref UInt32 result, ref byte pbuffer)
        {
            if (IntPtr.Zero == m_hComm)
                return 1;
        ...
        [DllImport("ALL.dll", EntryPoint = "API_MF_TransferCMD")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_Request_B")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_RESET_B")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_Anticoll_B")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_Attrib_B")]
        ...
        [DllImport("ALL.dll", EntryPoint = "API_TransferCMD_B")]
